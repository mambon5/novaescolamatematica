...
//        json_to_select(valclaus,"nom","clau","valclaus")
    ...
    <body onload="emptyform();horesdeclase(temps);escriu_profes();escriu_alumnes()">
       ...
       <h3 class="w3-center w3-text-black">
                  ...
                  Registrar un pagament <b>NEM</b></h3>

        



<form id="regForm" action="/php/registres/enviarpago.php" method="post" onsubmit="return validateForm()"
     >
...
<input  id="dia" placeholder="yyyy-mm-dd"  oninput="this.className = ''" 
 ...
 <input  id="tipureg" placeholder=""  style="display:none" value="nou"
   ...
   <div class="tab">
       ...
       <p>  <label for="cars">Hores que es paguen:</label> 
    ...
    <p>  <label>Desplaçaments que es paguen:</label> 
           <input id="viatges" value="0"  min="0" oninput="this.className = ''" 
                  name="viatges" type="number" required >

  </select></p>
  
  <p>  <label>Nombre de clases fetes a cafè/restaurant:</label> 
            <input id="cafes" value="0"  min="0" oninput="this.className = ''" 
                  name="cafes" type="number" required ></p>
   ...
   <div class="tab">
    <p><label>Diners que es paguen (€):</label> 
      <input  style="width:80%" id="diners" placeholder="25" min="0" oninput="this.className = ''" 
             name="diners" type="number" required> €</p>
    
   <p> <label for="cars">Codi a adjuntar al pagar:</label> 
        <input  readonly id="codi"  value="" name="codi" type="text" ></p>
