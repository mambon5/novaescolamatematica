  <?php 
      ...
      include("../php/getprofes.php");//contains basic connection settings
...
<html>
   ...
   <link rel="stylesheet" href="/css/slideformw3.css">
    ...
    <script src="/js/random_words.js"></script>
...
<!--     <script type="text/javascript" src="js/profes.json"></script>-->
    ...
    function profepag(elem) {
        var inhtml = elem.innerHTML;
        if(inhtml == "Profe") {
            elem.innerHTML = "Pagador";
            pagadiv.style.display = "block";
            profediv.style.display = "none";
            parentescdiv.style.display = "block";
            ...
            elem.innerHTML = "Profe";
            pagadiv.style.display = "none";
            profediv.style.display = "block";
            parentescdiv.style.display = "none";
            materiadiv.style.display = "block";
            pagador.value = "";
            datainicidiv.style.display = "block";
            datafidiv.style.display = "block";
        }
      ...
      var pagadors=<?php  echo $pagadors ?>;
    ...
    <body onload="escriu_profes();escriu_alumnes();escriu_pagadors();emptyform();">
        
        <div class="w3-bar w3-teal w3-top">
            <a href="" class="w3-bar-item w3-button">Cancela registre</a>
        </div>
        <br>
        <br>
       <h3 class="w3-center w3-text-black">
                  <i class="fa fa-home w3-margin-right" ></i>
                  Registrar una connexió <b>NEM</b></h3>

        

 

<form id="regForm" action="/php/registres/envia_connexio.php" method="post" onsubmit="return validateForm()"
     >
    
    
  <h1>Detalls de la connexió alumne - <button  id="profepagg" type="button" onclick="profepag(this);">Profe</button></h1>
  ...
  <!-- One "tab" for each step in the form: -->
   <div class="tab">
    ...
    <select  id="nomalumnes" placeholder="Juan Soraya..."  oninput="this.className = ''"
            name="alumne" type="text" required></select>
    </p>
    
    <p><div id="profediv" >
    <label>nom del profe</label>
    <select  id="nomprofes" placeholder="Maria de cases..."  
               oninput="this.className = ''" name="profe" type="text" required>
    </select>
 
    </div></p>

    
    <p> <div id="data_inici_div" >
    ...
    <select  id="nompagadors" placeholder="Juana de Arc..."  
               oninput="this.className = ''" name="pagador" type="text" required>
    </select></div>    
    ...
    <div id="materiadiv" >
     <label>Materia:</label><input  id="materia" placeholder="matemàtiques"  
               oninput="this.className = ''" name="materia" type="text" required>
    </div>
         
    <div id="parentescdiv" >
     <label>Parentesc:</label>
      <select  id="parentesc" placeholder="pare"  
               oninput="this.className = ''" name="parentesc" type="text" required>
         <option value="pare">pare</option>
         <option value="mare">mare</option>
         <option value="avi">avi</option>
         <option value="àvia">àvia</option>
         <option value="familiar">altre familiar</option>
         <option value="amic">amic</option>
         <option value="tutor">tutor</option>
         <option value="mecenes">mecenes</option>
    ...
    <div id="comentaridiv" >
        ...
        <input  id="comentari" placeholder="vol classes de fraccions especialment..."  
                name="comentari" value=" " type="text" >
    </div>    
    <br>
  ...
  <div style="text-align:center;margin-top:40px;">
    ...
    <span class="step"></span>
        ...
        <script src="/js/changecss_class.js"></script>

    
    <script src="/js/slidformw3.js"></script>
    <script>
        var profediv = document.getElementById("profediv");
        var pagadiv = document.getElementById("pagadiv");
        var parentescdiv = document.getElementById("parentescdiv");
        var materiadiv = document.getElementById("materiadiv");
        var alumne = document.getElementById("nomalumnes");
        var profe = document.getElementById("nomprofes");
        var pagador = document.getElementById("nompagadors");
