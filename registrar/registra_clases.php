...
//        json_to_select(valclaus,"nom","clau","valclaus")
    ...
    <body onload="emptyform();horesdeclase(temps);tempsdespl(tdesp);escriu_profes();escriu_alumnes()">
       ...
       <h3 class="w3-center w3-text-black">
                  ...
                  Registrar una clase <b>NEM</b></h3>

        



<form id="regForm" action="/php/registres/enviarclase.php" method="post" onsubmit="return validateForm()"
     >
...
tdesp = document.getElementById("tdesp");
