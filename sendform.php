...
//     require '../../PHPMailer-master/src/SMTP.php';
    ...
    //online hosting
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'contacte@nescolamatem.tech'; // email
        $mail->Password = 'Nemgalois_11'; // password
        $mail->setFrom('contacte@nescolamatem.tech', 'NEM'); // From email and name
...
//             echo "Message 1 sent!";
        ...
        $mail->addAddress($from, "NEM"); // to email and name
...
<!-- Global site tag (gtag.js) - Google Ads: 10810008082 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-10810008082"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-10810008082');
</script>
<!-- Event snippet for Contacto pag web conversion page -->
<script>
  gtag('event', 'conversion', {'send_to': 'AW-10810008082/M43xCPPnkIUDEJLEzqIo',
    'value': 1.0,
    'currency': 'EUR'});
</script>
<script>
...
//             window.location.href = "enviat.html";
        }
