...
echo "<br>";
 ...
 $sql = "INSERT INTO pagadors (data_inici, nom, 
...
VALUES ('" . $data_inici . "', '" . $nom .
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        echo "<br>Linia afegida a pagadors correctament";
      } else {
          $error = "error";
       exit("<br>Error afegint linia a pagadors: " . $conn->error);
      }
...
<html>
    <head>
       <link rel="icon" type="image/x-icon" href="/w3images/favicon.png">
        ...
        <head>
    <title>Pagadora registrada</title>
   <link rel="stylesheet" href="/css/slideformw3.css">
    ...
    <body onload="">
        ...
        <div class="w3-bar w3-teal w3-top">
            <a href="/registrar/registra_pagadora.html" class="w3-bar-item w3-button">Regsitra una pagadora</a>
        </div>
        <br>
        <br>
       <h3 class="w3-center w3-text-black">
                  <i class="fa fa-home w3-margin-right" ></i>
                  Pagadora registrada <b>NEM</b></h3>

        


<form id="regForm" action="" method="post" >
   <h1>Detalls de la pagadora:</h1>
  <!-- One "tab" for each step in the form: -->

  
  
       <div id="wrapper">
    <p> <label for="cars">Data inici pagadora</label> 
