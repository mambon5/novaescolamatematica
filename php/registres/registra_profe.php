...
echo "<br>";
 ...
 $sql = "INSERT INTO profes (data_inici, nom, 
...
VALUES ('" . $data_inici . "', '" . $nom .
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        echo "<br>Linia afegida a profes correctament";
      } else {
          $error = "error";
       exit("<br>Error afegint linia a profes: " . $conn->error);
      }
...
<!--     <script type="text/javascript" src="js/profes.json"></script>-->
    ...
    <body onload="">
        ...
        <div class="w3-bar w3-teal w3-top">
            <a href="/registrar/registra_profe.html" class="w3-bar-item w3-button">Regsitra una profe</a>
        </div>
        <br>
        <br>
       <h3 class="w3-center w3-text-black">
                  <i class="fa fa-home w3-margin-right" ></i>
                  Profe registrada <b>NEM</b></h3>

        


<form id="regForm" action="" method="post" >
   <h1>Detalls del profe:</h1>
  <!-- One "tab" for each step in the form: -->

  
  
       <div id="wrapper">
    <p> <label for="cars">Data inici profe</label> 
