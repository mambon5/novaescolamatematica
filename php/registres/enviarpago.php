<?php
   ...
   //  http://localhost/PHPexec.php?f=C:\Roma\Nebeans_repsol\Helico\public_html\php\sendscore.php
    ...
    include("../getprofes.php");//contains basic connection settings
   

    //  vars per una nova clase
        $tipureg = $_POST['tipureg'];
        $dia = $_POST['dia'];
        $diners = $_POST['diners'];
...
$pnomphp = json_decode($pnom);
 ...
 $sql = "INSERT INTO pagaments_clases (diners, hores,
     nom_profe, nom_alumne, codi, viatges, comentari, cafes)
VALUES ('" . $diners . "', '" . $hores_de_clase .
         "', '" . $profe . "', '" . $alumne . "', '" . $codi . 
         "', '" . $viatges . "', '" . $comentari . "', '" . $cafes . "')";
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        $missatge = "pagament registrat correctament";
          ...
          $error = "error";
          $missatge = "error registrant el pagament";
       exit("<br>Error afegint linia a pagos: " . $conn->error);
      }
...
<!--     <script type="text/javascript" src="js/profes.json"></script>-->
    ...
    document.getElementById("codi").value=paraularand(paraules,3);
    }
...
<form id="regForm" action="" method="post" 
  ...
  <p>  <label for="cars">Profe:</label> 
           <select name="nomprofes" id="nomprofes" onclick="deleteinvalid(this)" 
                   readonly>
               <option value=""><?php echo $profe ?></option>

  </select></p>
  <p>  <label for="cars">Alumne:</label> 
           <select name="nomalumnes" id="nomalumnes" onclick="deleteinvalid(this)"
                   readonly>
               <option value=""><?php echo $alumne ?></option>

  </select></p>
   
    <p>
          Dia de la primera clase que es paga:
<input  id="dia" placeholder="yyyy-mm-dd"  oninput="this.className = ''" 
               name="dia" type="date" readonly value="<?php echo $dia ?>"></p>
       ...
       <p>  <label for="cars">Hores:</label> 
           <select name="temps" id="temps" readonly>
               <option value=""><?php echo $hores_de_clase ?></option>

  </select></p>

  
    <p>  <label>Desplaçaments que es paguen:</label> 
           <input id="viatges"  min="0" oninput="this.className = ''" 
                  name="viatges" type="number" readonly value = "<?php echo $viatges ?>">

  </select></p>
  
  <p>  <label>Nombre de clases fetes a cafè/restaurant:</label> 
            <input id="cafes" value="<?php echo $cafes ?>"  min="0" oninput="this.className = ''" 
                  name="cafes" type="number" readonly ></p>
  
 
    <p><label>Diners que es paguen (€):</label> 
      <input  style="width:80%" id="diners" placeholder="25" min="0" oninput="this.className = ''" 
             name="diners" type="number" readonly value="<?php echo $diners ?>"> €</p>
    
   <p> <label for="cars">Codi a adjuntar al pagar:</label> 
        <input  readonly id="codi"  value="<?php echo $codi ?>" name="codi" type="text" ></p>
       
       
   <p>  <label >Comentari:</label> 
           <input type="text" name="comentari" id="comentari" 
                  placeholder="Es paguen dos clases..."  
                  value="<?php echo $comentari ?>" readonly
...
viatges = document.getElementById("viatges");

disponib = []; //array 2d amb hores disponibles a cada dia.
</script>
